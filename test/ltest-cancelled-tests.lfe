;;;; This module is meant to test the ability to recognize cancelled
;;;; tests (e.g.  fixture tests that have bad contents).
;;;;
;;;; In order to enable this test, take the number one (1) out of the behaviour
;;;; name below, and you should see "One or more tests were cancelled." in the
;;;; runner output.
;;;;
...
(defun setup_test_case (set-up-result)
  ...
  ;; XXX I don't think this test is working as it should ...
